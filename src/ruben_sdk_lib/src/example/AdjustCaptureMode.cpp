...
int main(int argc, char *argv[]) {
    ...
    // Set capture mode to fast mode, or by setting RVC::CaptureMode_Normal to normal mode, or by setting
    // RVC::CaptureMode_AntiInterReflection to anti-interreflection mode.
